...
# line 6 marks decimal point (artifact of the comma script)
# line 7 marks 28 000 etc.
# line 8 marks rest of the numbers
# line 9 parses formal (SI) units directly after a number
# line 10 parses informal units
# line 11 parses formal (SI) units after a number and a space
# line 12 parses combination units such as mg/kg
# line 13 TODO parses "56 mg/100 ml", "8 g / 100 g" etc.
# line 14: if there are no units, put a space back
cat |\
